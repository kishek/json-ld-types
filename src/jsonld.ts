  ...
  */
    ...
    */
    ...
    export interface Object<T = any> {
      ...
      preview?: Primitives.Link | Primitives.Object;
  ...
  export namespace Data {
    ...
    export type DocumentAction = DeleteAction | ViewAction | DownloadAction | ShareAction | CommentAction | WatchAction;
    ...
    export type PageAction = ViewAction | DownloadAction | ShareAction | CommentAction | WatchAction;
    ...
    export type SourceCodePullRequestAction = DeleteAction | ViewAction | DownloadAction | WatchAction;
    export interface SourceCodePullRequest extends BaseData {
      ...
      'atlassian:updatedBy'?: Primitives.Link | Primitives.Person;
      'atlassian:state': string | Primitives.Link | Primitives.Object; // xsd:string | rdf:langString
    ...
    export type SourceCodeRepositoryAction = DeleteAction | ViewAction | DownloadAction | WatchAction;
    ...
    export interface Task extends BaseData, Primitives.AssignedObject {
      ...
      'atlassian:isDeleted'?: boolean;
      'atlassian:priority'?: number; // Float; 0 <= x <= 1
      'atlassian:priorityName'?: string;
